...
extension DatabaseManager {
    ...
    //Create a new conversation with target useremail and first message sent
    ...
    //E-postada iletilen kullanıcı için tüm konuşmaları getirir ve döndürür
    ...
    public func sendMessage(to conversation: String, otherUserEmail: String ,name: String, newMessage: Message, completion : @escaping (Bool) -> Void){
        ...
        //Yeni mesaj ekleme
        //update sender son mesaji
        // update recipient son mesaji
        guard let myEmail = UserDefaults.standard.value(forKey: "email") as? String else {
            completion(false)
            return
        }
